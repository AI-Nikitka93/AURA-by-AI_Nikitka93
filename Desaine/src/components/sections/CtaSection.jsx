  ...
  return (
    <section id="cta" className="relative py-20 sm:py-24 lg:py-32">
      ...
      <div className="section-shell relative">
        <div className="liquid-panel overflow-hidden px-5 py-12 text-center sm:px-8 sm:py-14 lg:px-16 lg:py-20 reveal-scale">
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            <div className="mt-8 flex flex-col items-center gap-3 sm:mt-10 sm:flex-row sm:justify-center">
              <a href="#ritual" className="primary-button relative w-full overflow-hidden px-6 py-3.5 text-[11px] uppercase tracking-[0.2em] sm:w-auto sm:px-8 sm:py-4 sm:text-sm sm:tracking-[0.24em]">
                {ctaContent.button}
              </a>
        ...
        <div className="mx-auto mt-10 max-w-md sm:mt-14 reveal">
          <EmailSignupForm />
        </div>
      </div>
    </section>
